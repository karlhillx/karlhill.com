...
return [
    ...
    'expertise' => [
        ...
        'Cloud-Native Mission Systems',
        'Platform Engineering & Developer Experience',
        'DevSecOps, CI/CD & Release Governance',
        'Secure SDLC & Engineering Standards',
        'Architecture, APIs & Systems Integration',
        'Multi-Environment Delivery & Integration Risk',
        'Agile Delivery, Planning & Stakeholder Alignment',
        'Observability, Reliability & Operational Readiness',
    ],
];
