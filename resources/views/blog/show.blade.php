...
<article class="relative pt-28 pb-20 px-6">
    ...
    <div class="relative z-10 max-w-3xl mx-auto">
        <a href="/blog"
           class="inline-flex items-center gap-2 font-mono text-[11px] text-neutral-500 hover:text-orange-500 uppercase tracking-widest mb-8 transition-colors">
            <span aria-hidden="true">←</span> All Writing
        </a>

        <p class="font-mono text-orange-500 text-xs tracking-widest uppercase mb-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            <div>
                <p class="font-mono text-orange-500 text-xs tracking-widest uppercase mb-2">Share</p>
                <div class="flex items-center gap-4">
                    ...
                    <span data-copy-feedback class="font-mono text-[10px] text-orange-500 uppercase tracking-widest opacity-0 transition-opacity">Copied</span>
                </div>
            </div>
            <div class="text-right">
                <p class="font-mono text-[10px] text-neutral-600 uppercase tracking-widest mb-2">Written by</p>
                <a href="/" class="font-display text-2xl text-neutral-300 hover:text-orange-500 tracking-widest transition-colors">
                    Karl Hill
                </a>
            </div>
        </div>
