                ...
                <div data-reveal>
                    ...
                    <div class="flex flex-wrap gap-2">
                        @foreach($group['skills'] as $skill)
                            <span class="surface-chip font-mono text-xs px-3 py-1.5 text-neutral-400 hover:border-accent/60 hover:text-accent/80 transition-colors cursor-default">{{ $skill }}</span>
                        @endforeach
                    </div>
                </div>
            @endforeach
