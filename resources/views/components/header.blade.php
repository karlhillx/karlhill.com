<header class="py-3 sm:py-4 color-maroon-dream bg-opacity-95 backdrop-blur-xl fixed w-full top-0 z-50 shadow-lg border-b border-white/10 transition-all duration-300">
