...
<div x-data="contactModal" x-cloak>
    ...
    <div x-show="open" 
        ...
        <div class="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden"
             @click.stop>
            <!-- Modal Header -->
            <div class="relative px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-cyan-50">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">I'd love to hear from you</p>
                        </div>
                    </div>
                    <button @click="close()" 
                            type="button"
            ...
            <div class="p-6">
                ...
                <form @submit.prevent="submit()" x-show="!success">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-4 py-3 rounded-lg border bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 transition-colors"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="contact-message"
                                  ...
                                  required
                                  rows="5"
                                  :class="errors.message ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-indigo-500 focus:ring-indigo-500'"
                                  class="w-full px-4 py-3 rounded-lg border bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 transition-colors resize-none"
                                  placeholder="Tell me about your project or how I can help..."></textarea>
                        <p x-show="errors.message" class="mt-1 text-xs text-red-600" x-text="errors.message"></p>
                    </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="flex items-center justify-center gap-2">
                        ...
                        <a href="mailto:{{ $email }}" 
                           class="text-sm text-indigo-600 hover:text-indigo-800 font-medium break-all">
                            {{ $email }}
                        </a>
                    </div>
                </div>
