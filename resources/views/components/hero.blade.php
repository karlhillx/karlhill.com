    ...
    <div class="mx-auto max-w-7xl lg:px-8">
        <div class="relative px-4 sm:px-8 lg:px-12">
            <div class="mx-auto max-w-2xl lg:max-w-5xl">
                <section class="px-8 mt-20 sm:mt-32 md:mt-40">
                    <!-- Hero Title -->
                    <h2
                        x-show="show"
                    ...
                    <div class="mt-6 max-w-3xl"
                        ...
                        <p class="text-lg">
                            ...
                            groundbreaking research with the world. When I'm not coding, I dedicate my time to the arts as a
                            volunteer at
                            <x-link href="https://americanart.si.edu/visit/renwick" external>The Renwick Gallery</x-link>
                            and the
                            <x-link href="https://americanart.si.edu/" external>Smithsonian American Art Museum</x-link>.
                            My diverse interests extend into music, where I find creative expression through performance and
                            composition.
                        </p>
                    </div>
