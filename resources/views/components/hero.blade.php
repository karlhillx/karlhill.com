        ...
        <div class="mx-auto max-w-7xl lg:px-8">
            <div class="relative px-4 sm:px-8 lg:px-12">
                ...
                <div class="pointer-events-none absolute inset-x-0 -top-24 -z-10 overflow-hidden blur-3xl" aria-hidden="true">
                    <div class="relative left-1/2 -translate-x-1/2 aspect-[1155/678] w-[36rem] sm:w-[72rem] bg-gradient-to-tr from-sky-400 to-indigo-400 opacity-30 dark:opacity-20"></div>
                </div>
