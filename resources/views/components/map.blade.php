<section id="map" class="relative overflow-hidden bg-gradient-to-br from-gray-200 via-gray-100 to-gray-200 border-t border-yellow-400 py-8 sm:py-12">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute bottom-0 right-1/4 w-96 h-96 bg-yellow-400/20 rounded-full blur-3xl animate-map-orb-2"></div>
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-indigo-400/10 rounded-full blur-3xl animate-map-orb-3"></div>
    </div>
    ...
    <div class="relative max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative map-container">
            ...
            <div class="absolute -inset-1 bg-gradient-to-r from-yellow-400 via-blue-400 to-indigo-400 rounded-lg opacity-75 blur-sm animate-map-border-glow"></div>
