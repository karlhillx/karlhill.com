<div class="flex flex-col gap-16">
                ...
                <div class="flex flex-col items-start">
                        ...
                        <h2 class="text-xl font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">
                            ...
                            <a href="https://tailwindcss.com/blog/tailwindcss-v4-alpha" target="_blank"
                               class="hover:text-orange-500 transition-colors">
                                ...
                                <span class="relative z-10">Embracing the Future with Tailwind CSS v4 Beta</span>
                            </a>
                        </h2>
                        <time
                    ...
                    <div class="mt-4 prose prose-zinc dark:prose-invert">
                        <p class="relative z-10 text-sm text-zinc-600 dark:text-zinc-400">
                            ...
                            staying ahead of the curve and delivering a more efficient, flexible, and visually appealing
                            user experience. Explore my portfolio to see Tailwind CSS v4 Alpha in action and witness the
                            future of web styling firsthand.
                        </p>
                    </div>
                </div>
            </article>

            <!-- Livewire + Inertia Article -->
            <article class="group relative">
                <div class="flex flex-col items-start">
                    <header class="w-full">
                        <h2 class="text-xl font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">
                            ...
                            <a href="https://laravel-livewire.com/" target="_blank"
                               class="hover:text-orange-500 transition-colors">
                                <span class="absolute -inset-y-6 -inset-x-4 z-20 sm:-inset-x-6 sm:rounded-2xl"></span>
                                <span class="relative z-10">Livewire + Inertia</span>
                            </a>
                        </h2>
                        <time
                            class="relative z-10 mt-2 flex items-center text-sm text-orange-400 dark:text-zinc-500 pl-3.5"
                    ...
                    <div class="mt-4 prose prose-zinc dark:prose-invert">
                        <p class="relative z-10 text-sm text-zinc-600 dark:text-zinc-400">
                            ...
                            you to use those components on the front end with minimal JavaScript. Together, these tools
                            can make building modern, responsive web applications with minimal code easier. Livewire and
                            Inertia are easy to learn and use, and they can be a great addition to your toolkit as a
                ...
                <div class="flex flex-col items-start">
                    <header class="w-full">
                        <h2 class="text-xl font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">
                            ...
                            <a href="https://laravel-vite.dev/" target="_blank"
                               class="hover:text-orange-500 transition-colors">
                                <span class="absolute -inset-y-6 -inset-x-4 z-20 sm:-inset-x-6 sm:rounded-2xl"></span>
                                <span class="relative z-10">Transitioning from Laravel Mix to Vite</span>
                            </a>
                        </h2>
                        <time
                            class="relative z-10 mt-2 flex items-center text-sm text-orange-400 dark:text-zinc-500 pl-3.5"
                    ...
                    <div class="mt-4 prose prose-zinc dark:prose-invert">
                        <p class="relative z-10 text-sm text-zinc-600 dark:text-zinc-400">
                            ...
                            production. When building applications with Laravel, you will typically use Vite to bundle
                            your application's CSS and JavaScript files into production ready assets. Laravel integrates
                            seamlessly with Vite by providing an official plugin and Blade directives to load your
                            assets for development and production.
                        </p>
                    </div>
                </div>
            </article>
                    ...
                    <header class="w-full">
                        <h2 class="text-xl font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">
                            ...
                            <a href="https://tailwindcss.com/" target="_blank"
                               class="hover:text-orange-500 transition-colors">
                                <span class="absolute -inset-y-6 -inset-x-4 z-20 sm:-inset-x-6 sm:rounded-2xl"></span>
                                <span class="relative z-10">Rewriting interfaces with TailwindCSS</span>
                            </a>
                        </h2>
                        <time
                            class="relative z-10 mt-2 flex items-center text-sm text-orange-400 dark:text-zinc-500 pl-3.5"
                    ...
                    <div class="mt-4 prose prose-zinc dark:prose-invert">
                        <p class="relative z-10 text-sm text-zinc-600 dark:text-zinc-400">
                            ...
                            look, consider rewriting it with TailwindCSS. When I first came across <a
                                ...
                                class="text-orange-500 hover:text-orange-600 transition-colors">TailwindCSS</a>, I was
                            amazed by the framework's simplicity. I rewrote my interfaces in a matter of minutes with
                            efficiency and maintainability, leaving me more time to focus on the core of my
                            applications. I have since used TailwindCSS in all of my new projects.
                        </p>
                    </div>
                </div>
            </article>
    ...
    <!-- Add this article after the TailwindCSS article and before the closing div -->
    <article class="group relative">
        <div class="flex flex-col items-start">
            <header class="w-full">
                <h2 class="text-xl font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">
