                    ...
                    <div class="relative px-4 sm:px-8 lg:px-12">
                        <div class="mx-auto max-w-2xl lg:max-w-5xl">
                            ...
                            <div class="max-w-2xl"><h1
                                ...
                                <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">I’m Karl, a full-stack
                                    software
                                    engineer at <a href="https://www.nasa.gov/goddard/">NASA Goddard Space Flight
                                        Center</a>.
                                    I am responsible for building and maintaining some of the agency’s
                                    best internal and external web applications. Besides working for NASA, I volunteer
                                    for
                                    ...
                                    volunteer for several other non-profit organizations. In my free time, I enjoy
                                    playing
                                    music.
                                </p>
                                ...
                                <div class="flex flex-col gap-16">
                                    ...
                                    <article class="group relative flex flex-col items-start">
                                        <h2 class="text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">
                                            ...
                                            <span
                                                ...
                                                <span
                                                    class="relative z-10">Embracing the Future with Tailwind CSS v4 Alpha</span>
                                            </a>
                                        </h2>
                                        <time
                                        ...
                                        <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                                            I've recently integrated Tailwind CSS v4 Alpha into my portfolio, pushing
                                            the
                                            boundaries of modern web design. This cutting-edge version brings exciting
                                            new
                                            features like native color opacity, simplified custom values, and improved
                                            performance. By adopting v4 Alpha, I'm staying ahead of the curve and
                                            delivering
                                            a more efficient, flexible, and visually appealing user experience. Explore
                                            my
                                            portfolio to see Tailwind CSS v4 Alpha in action and witness the future of
                                            web
                                            styling firsthand.
                                        </p>
                                    </article>
                                    ...
                                    <article class="group relative flex flex-col items-start">
                                        ...
                                        <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                                            ...
                                            using PHP. In contrast, Inertia enables you to use those components on the
                                            front
                                            end with minimal JavaScript. Together, these tools can make building modern,
                                            responsive web applications with minimal code easier. Livewire and Inertia
                                            are
                                    ...
                                    <article class="group relative flex flex-col items-start">
                                        ...
                                        <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                                            ...
                                            with Laravel, you will typically use Vite to bundle your application's CSS
                                            and
                            ...
                            <div class="flex-1">
                                ...
                                <a href="#" class="block mt-2">
                                    ...
                                    <p class="mt-3 text-base text-gray-500">
                                        ESCCOR is a cutting-edge platform revolutionizing Earth science data management.
                            ...
                            <div class="flex-1">
                                ...
                                <a href="#" class="block mt-2">
                                    ...
                                    <p class="mt-3 text-base text-gray-500">
                                        ...
                                        ecosystems and climate from NASA's satellite missions and field research. Using
                        ...
                        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                            <div class="flex-1">
                                ...
                                <a href="#" class="block mt-2">
                                    ...
                                    <p class="mt-3 text-base text-gray-500">
                                        The Direct Readout Laboratory (DRL) serves as a crucial technology conduit for
                                        the
                                        ...
                                        innovative role in facilitating real-time data transmission from Earth-observing
                                        satellites to global ground stations. The sleek interface aims to provide
                                        seamless
                                        access
                                        to mission-critical information, enhancing environmental monitoring capabilities
                                        and
                        ...
                        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                            <div class="flex-1">
                                ...
                                <a href="#" class="block mt-2">
                                    ...
                                    <p class="mt-3 text-base text-gray-500">
                                        Verizon Business' Finium™ platform revolutionizes cybersecurity by integrating
                                        threat intelligence, vulnerability data, and security events in a centralized
                                        web
                                        console. Operating from a disaster-resilient Security Operations Center, this
                                        cutting-edge system empowers analysts and business leaders to proactively manage
                                        security as a strategic asset. My work on Finium™ contributed to transforming
                        ...
                        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                            <div class="flex-1">
                                ...
                                <a href="#" class="block mt-2">
                                    ...
                                    <p class="mt-3 text-base text-gray-500">
                                        InformedDNA leads the applied genomics field, optimizing clinical decisions with
                                        cutting-edge genomics expertise. Their IDNAPortal, which I developed, is a
                                        sophisticated platform that analyzes and interprets genomic data. It provides
