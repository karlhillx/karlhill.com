...
<section id="path" data-section-label="Next" aria-labelledby="path-heading" class="site-section site-section--soft border-t border-neutral-800/50">
    <div class="site-shell">
        ...
        <p class="text-neutral-300 text-lg leading-relaxed max-w-2xl mb-10 sm:mb-12" data-reveal>
            Three places that answer a hiring conversation. Start with the leave-behind, then the evidence, then a time on the calendar.
        </p>
        <ol class="home-path grid gap-px bg-neutral-800/50 sm:grid-cols-3" data-reveal>
            <li class="home-path__item bg-bg p-6 sm:p-8">
                ...
                <p class="text-neutral-400 text-sm leading-relaxed">Bio, PDF, and canonical links — the leave-behind to forward.</p>
            </li>
            <li class="home-path__item bg-bg p-6 sm:p-8">
            ...
            <li class="home-path__item bg-bg p-6 sm:p-8">
                ...
                <p class="text-neutral-400 text-sm leading-relaxed">Pick a time. Prefer email? Use the contact form below.</p>
            </li>
        </ol>
    </div>
</section>
