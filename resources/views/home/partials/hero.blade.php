...
<section id="hero" data-section-label="Top" class="hero relative min-h-[100svh] flex flex-col justify-end overflow-hidden site-gutter">
    {{-- Atmosphere only — no product/screenshot photography in the hero. --}}
    ...
    <div class="relative z-10 site-shell w-full">
        <div class="hero-copy">
            <p class="hero-kicker font-mono text-accent uppercase tracking-widest hero-enter" style="animation-delay:80ms">
                {{ $person['job_title'] }}
                <span class="hero-kicker__sep" aria-hidden="true">·</span>
                {{ $person['employer_display'] ?? $person['employer'] }}
            </p>
