...
PURCHASED: list[dict[str, str]] = [
    ...
    {"product": 'P.J. Valckenberg "It\'s not a SIN" Ginger / Bitter Orange Peel', "brand": "P.J. Valckenberg", "category": "Non-alcoholic wine", "abv": "<0.5%", "dealcoholized": "Yes (hybrid finish)", "method": "Vacuum rectification at 30°C; finished with natural ginger flavor, bitter-orange-peel distillate, and carbonic acid", "retailers": "InternetWines.com", "times": "1", "first": "2026-07-26", "recent": "2026-07-26"},
