...
country: Germany
region: Rheinhessen
style: 'Dealcoholized dry Riesling'
abv: 0.3%
abv_numeric: 0.3
abv_qualifier: exact
production_type: dealcoholized
verified: 'yes'
dealcoholization_method: 'Vacuum dealcoholization after full vinification at about 28°C, with volatile aroma compounds collected and returned (producer FAQ / product page)'
base_beverage: '100% Riesling, fermented then dealcoholized'
producer: 'Weinkellerei Weinkönig GmbH'
volume: '750 ml'
price: '$21.00 (Dis&Dis purchase)'
availability: 'Weinkönig, Honest & Rare, Dis&Dis, WirWinzer'
...
sources:
  -
    ...
    claims:
      ...
      - calories
  -
    title: 'Weinkönig Riesling alkoholfrei — WirWinzer'
    url: 'https://wirwinzer.de/weinkoenig-riesling-alkoholfrei-2050006000.html'
    claims:
      - abv
      - base_beverage
      - country
      ...
      - volume
  -
    title: 'Weinkönig Riesling dealcoholized — Honest & Rare'
    url: 'https://www.honest-rare.de/en/weinkoenig-riesling-de-alcoholized-white-wine/'
    claims:
      - base_beverage
      - dealcoholized
      - country
      ...
      - sugar
  -
    title: 'Weinkönig Riesling nr.420 Organic 0% — Dis&Dis'
