...
sources:
  - title: "Zolo Zero Non-Alcoholic Malbec Rosé — Vino del Sol technical sheet"
    ...
    claims: [abv, dealcoholized, method, base_beverage, producer, country, region, volume, sugar, calories]
  - title: "Zolo Zero Malbec Rosé — InternetWines.com"
    url: https://internetwines.com/
    claims: [availability]
discrepancies:
  - field: abv
    note: "The Vino del Sol tech sheet lists alcohol as 0%. Some Argentine retail listings print 0.3% vol. We cite the importer sheet as the primary figure and flag the retail variance."
status: published
---
