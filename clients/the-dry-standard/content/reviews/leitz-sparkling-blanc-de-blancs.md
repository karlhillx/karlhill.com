...
sources:
  - title: "Leitz Eins-Zwei-Zero Riesling (published review — same process)"
    ...
    claims: [dealcoholization_method, producer, country, region, availability, volume, base_beverage, dealcoholized]
  - title: "Leitz Eins Zwei Zero Sparkling Riesling (published — same producer)"
    url: https://karlhill.com/clients/the-dry-standard/reviews/wine/leitz-eins-zwei-zero-sparkling-riesling/
    claims: [producer, abv]
status: published
---
