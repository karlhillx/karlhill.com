...
class LlmsTxtBuilder
{
    ...
    public function build(): string
    {
        ...
        array_push($lines, ...[
            ...
            '- [About]('.$base.'/about): How I lead, career arc, and research',
    ...
    protected function recruiterSection(string $base, array $person): array
    {
        ...
        $lines = [
            ...
            '- Trajectory: '.($person['trajectory'] ?? 'Staff Aerospace Software Engineer → Engineering Manager (platform / DevSecOps / mission software)'),
