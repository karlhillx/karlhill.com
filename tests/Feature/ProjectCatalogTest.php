...
it('portfolio lists trajectory chapters and keeps supporting studies routable', function () {
    ...
    $this->get('/work')
        ...
        ->assertSee('Mission software, Earth science systems, and engineering infrastructure', escape: false)
        ...
        ->assertSee('distributed messaging, simulation workflows', escape: false)
