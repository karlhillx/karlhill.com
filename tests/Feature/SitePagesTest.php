...
it('about page renders leadership, delivery, career, numbers, and research', function () {
    ...
    $response->assertSee('The work has grown from building software other people depend on', escape: false);
...
it('recruiter kit one-pager links resume pdf bio and booking', function () {
    ...
    $response->assertSee('Engineering management is a natural next step', escape: false);
    $response->assertSee('Principal-level technical leadership remains an equally strong path', escape: false);
